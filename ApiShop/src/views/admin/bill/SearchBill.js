    ...
    render() {
        return <>
                ...
                <div className="flex flex-wrap mt-4">
                    ...
                    <CardSearchBill dataProperties={this.state.response.data} deleteProperties={this.delete} id={this.setSelectedId} setSelectedIdProperties={this.setSelectedId} /><br />
                    </div>
                </div>
                    ...
                    <div className="w-full lg:w-12/12 px-4">
                        <div className="relative w-full mb-3">
                            ...
                            <div class="relative inline-block w-full text-gray-700">
                                <select name="buyerId" value={this.state.buyerId} onChange={this.props.setParam} class="w-full h-10 pl-3 pr-6 text-base placeholder-gray-600 border rounded-lg appearance-none focus:shadow-outline" placeholder="Regular input">
