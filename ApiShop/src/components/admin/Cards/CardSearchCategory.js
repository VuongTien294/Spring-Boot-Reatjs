                    ...
                    {this.props.dataProperties.map(item => {
                        return <tr key={item.id}>
                            ...
                            <td className="border px-4 py-2">
                                <button className="bg-transparent hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded" type="button"><Link to={"/admin/category/update/" + item.id}><i className="fas fa-tools mr-2 text-sm"></i></Link></button>
